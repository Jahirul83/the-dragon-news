        ...
        <Box>
            <Card className='my-5'>
                <CardActionArea>
                    ...
                    <CardContent>
                        <p className='w-[100px] bg-red-500 text-white px-2 my-5 rounded'>{data[0].category}</p>
                        ...
                        <Grid key={news.id} item xs={6}>
                            <Card className='my-5'>
                                <CardActionArea>
                                    ...
                                    <CardContent>
                                        <p className='w-[100px] bg-red-500 text-white px-2 my-5 rounded'>{news.category}</p>
